...
class GetDepth:
    def __init__(self):
        ...
        self.pu = None
        self.py = None
        self.sub_c = rospy.Subscriber("aim_px", Detection2DArray, self.callback_center, queue_size=1)
        ...
        self.pub_position = rospy.Publisher("obj_positon", PoseStamped,queue_size=5)
    ...
    def callback_depth(self,data=Image):
        ...
        try:
            ...
            if self.puv_refreshed == True & self.odom_refreshed == True:
                ...
                obj_positon_msg.pose.orientation.w = 0
